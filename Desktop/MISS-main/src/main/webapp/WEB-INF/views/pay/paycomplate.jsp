     ...
     <div id = "movie_comimp">
        ...
        <div >
            ...
            <div id = "precaution">
                ...
                <div class = "precaution_contents">- 상영시작이 시작 후에는 환불이 불가합니다.</div>
                <div class = "precaution_contents">- 본 서비스는 스트리밍 서비스이므로 네크워크가 원활한 환경에서 시청바랍니다.</div>
                <div class = "precaution_contents">- 예매취소는 마이페이지에서 하실 수 있습니다.</div>
                <div class = "precaution_contents">- 영상이 끊어지거나 문제가 있을 경우 <span style="color:indianred">02-1234-5678</span>로 연락주시기 바랍니다.</div>
            </div>
